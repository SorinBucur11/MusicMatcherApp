...
// Edited by Bucur Sorin
// sorin.bucur11@gmail.com
...
public class WavFile
{
	...
	// Double
	// ------
	public int readFrames(double[] sampleBuffer) throws IOException, WavFileException
	{
		return readFrames(sampleBuffer, 0, (int) getNumFrames());
	}
